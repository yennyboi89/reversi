...
/*What to do when someone says that someone left the room*/
socket.on('player_disconnected',function(payload){
  ...
  /* If someone left the room, then animate all out their content */
  var dom_elements = $('.socket_'+payload.socket_id);
...
socket.on('game_update',function(payload){
  ...
  console.log('Something bad happened. socket game_update');
      return;
  }
...
if(socket.id == payload.game.player_white.socket){
  ...
  /* Something weird happened or is going on, like three people playing at once.*/
