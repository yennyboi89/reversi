        ...
        for(column = 0; column < 8; column ++){
            ...
            if (old_board[row][column] !=board [row][column]){
                if(old_board[row][column] == '?' && board[row][column] == ' '){
                    ...
                    $('#' + row + '_' + column).html('<img src="assets/images/white_to_black.gif" alt="white Square"/>');
                }
                else if(old_board[row][column] == 'b' && board[row][column] == 'w'){
                    $('#' + row + '_' + column).html('<img src="assets/images/black_to_white.gif" alt="black Square"/>');
                }
                else {
