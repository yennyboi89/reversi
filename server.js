...
io.sockets.on('connection', function (socket){
    ...
    */
    ...
    /* payload:
        ...
        {
            'result': 'success',
            'username' : username of the person that spoked,
    ...
    */
    ...
    socket.on('invite',function(payload){
        ...
        if(!roomObject.sockets.hasOwnProperty(requested_user)){
            var error_message = 'invite requested user that wasn\'t in the room, command aborted';
            log(error_message);
            socket.emit('invite_response', {
                result: 'fail',
                message: error_message
    ...
    */
    ...
    socket.on('game_start',function(payload){
        ...
        /* Make sure the user being invited is in the room */
        if(!roomObject.sockets.hasOwnProperty(requested_user)){
            var error_message = 'game_start requested user that wasn\'t in the room, command aborted';
            log(error_message);
            socket.emit('game_start_response', {
                result: 'fail',
                message: error_message
        ...
        /* if everything is okay, respond to the game stater that it was successful */
    ...
    /* payload:
		...
		if successful, a success message will be followed by game update message
        play_token_reponse:
        {
            'result': 'success',
        }
    ...
    */
    ...
    socket.on('play_token',function(payload){
        ...
        if(('undefined' === typeof game_id) || !game_id){
            var error_message = 'play token cant find your game board';
            log(error_message);
            socket.emit('play_token_response', {
                result: 'fail',
                message: error_message
...
/* This is code related to the game_state */
...
function send_game_update(socket, game_id, message){
    ...
    /* makes sure that only two people are in the game room */
	...
	if((games[game_id].player_white.socket != socket.id) && (games[game_id].player_black.socket != socket.id)){
		...
		/* if there isn't color to give them */
